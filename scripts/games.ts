...
{
  pushCommands({name: "Games", emoji: global.Emojis.Game}, 
  [
    createCommand("8ball", "8ball n shit", function(msg, str) {
      let ans = "";
    ...
    createCommand("flip", "flip a coin", function(msg, str) {
      var coin = (Math.floor(Math.random() * 2) == 0) ? 'heads' : 'tails';
      let result = coin.toString();
      msg.channel.send(result);
    }),

    createCommand("roll", "roll som die", function(msg, str) {
